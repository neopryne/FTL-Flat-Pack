...
set "RELATIVE_FILE=Flat Pack.zip"
set "ABSOLUTE_PATH=C:\Program Files (x86)\Steam\steamapps\common\FTL Faster Than Light\mods\Flat Pack.zip"

set "FILE_TO_EXECUTE=C:\Users\GunBuild-1\Documents\Workspace\Flat Pack\modman_orig.exe - Shortcut.lnk"
REM Define the path to the shortcut file
set "SHORTCUT_PATH=C:\Users\GunBuild-1\Documents\Workspace\Flat Pack\modman_orig.exe - Shortcut.lnk"
